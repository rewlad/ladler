...
class ErrorAttributes(
  ...
  val errorMsg: Attr[String] = attr("946913bd-e644-4ff0-8aa1-75ff95e6e7d9", valueTypes.asString),
  val realm: Attr[Obj] = attr("9dbb1e0f-523f-4e7b-b524-6dfd7a12a681", valueTypes.asObj),
  val show: Attr[Boolean] = attr("1626b864-21ae-4517-8006-c3d104852488", valueTypes.asBoolean)
)
